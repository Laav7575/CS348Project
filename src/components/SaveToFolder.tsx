...
export default function LikeButton({ cID }: { cID: string }) {
  ...
  return (
    <div className="relative inline-block mt-4">
      ...
      {showDropdown && (
        <div className="absolute mt-2 w-72 border border-gray-300 bg-white rounded shadow z-10 p-4">
          <div className="mb-2 font-semibold text-black ">Select Folders:</div>
          <div className="max-h-40 overflow-y-auto mb-3">
            {folders.map((folder) => (
              <label key={folder.fID} className="block text-sm mb-1 text-black">
                <input
                  type="checkbox"
          ...
          <div className="border-t pt-2 mt-2">
            <input
              ...
              className="w-full border px-2 py-1 rounded mb-2 border-gray-700 text-black"
            />
            <button
